...
public class Player {
  ...
  public List<Card.Mutable> getHandCard() {
    return hand;
  }

  /**
   * Removes first card in hand.
   */
  public void removeCard() {
    Card.Mutable card = hand.remove(0);
    card.show(true);
    System.out.println("Value: " + card.getValue() + " Color:" + card.getColor());
  }
